...
public interface CalculatorListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the {@code ExprUnario}
	 * labeled alternative in {@link CalculatorParser#expr}.
	 * @param ctx the parse tree
	 */
	void enterExprUnario(CalculatorParser.ExprUnarioContext ctx);
	/**
	 * Exit a parse tree produced by the {@code ExprUnario}
	 * labeled alternative in {@link CalculatorParser#expr}.
	 * @param ctx the parse tree
	 */
	void exitExprUnario(CalculatorParser.ExprUnarioContext ctx);
	/**
